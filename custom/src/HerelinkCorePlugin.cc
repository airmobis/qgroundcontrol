...
HerelinkCorePlugin::HerelinkCorePlugin(QGCApplication* app)
    : QGCCorePlugin { app } {
}

QGCOptions* HerelinkCorePlugin::options(void) {
...
void HerelinkCorePlugin::factValueGridCreateDefaultSettings() {
