...
- GStreamer 1.26 provides its own `FindGStreamer.cmake` file, but it's necessary to **prepend** its directory to `CMAKE_MODULE_PATH`, or the Qt version is tried first and fails
